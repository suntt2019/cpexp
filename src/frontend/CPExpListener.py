...
class CPExpListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CPExpParser#r.
    def enterR(self, ctx:CPExpParser.RContext):
        pass

    # Exit a parse tree produced by CPExpParser#r.
    def exitR(self, ctx:CPExpParser.RContext):
        pass
